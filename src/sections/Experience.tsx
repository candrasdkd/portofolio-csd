      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-10">
            {['All', 'Contract', 'Freelance'].map((t) => (
              <button
                key={t}
                onClick={() => setFilter(t as any)}
                className={`px-4 py-2 rounded-full text-xs font-bold transition-all border ${
                  filter === t 
                  ? 'bg-primary border-primary text-dark shadow-[0_0_15px_rgba(var(--primary-rgb),0.4)]' 
            ...
            {filteredExperience.map((item, index) => (
              ...
              >
                ...
                <div className="md:w-1/2 pl-12 md:pl-0">
                  <div className={`p-6 bg-card rounded-2xl border border-gray-800 hover:border-primary/50 transition-all shadow-xl group ${index % 2 === 0 ? 'md:mr-8' : 'md:ml-8'}`}>
                    ...
                    <div className="mb-4 mt-1">
                      <h4 className="text-gray-400 font-medium">{item.company}</h4>
                      {item.clients && item.clients.length > 0 && (
                        <div className="flex flex-wrap items-center gap-2 mt-2">
                          <span className="text-gray-600 text-[10px] uppercase font-bold italic">at client:</span>
